...
COINPAIRS = ['BNBBTC']
HISTORY_STRUCTURE = ['OPEN_TIME', 'OPEN', 'HIGH', 'LOW', 'CLOSE', 'VOLUME', 'CLOSE_TIME', 'QUOTE_ASSET_VOLUME', 'NUMBER_TRADES', 'TAKER_BASE_ASSET_VOLUME', 'TAKER_QUOTE_ASSET_VOLUME', 'IGNORE']
POLICY_STRUCTURE = ['COINPAIR', 'TYPE', 'BASE_PRECISION', 'MIN_PRICE', 'MAX_PRICE', 'PRICE_SIZE', 'MIN_QTY', 'MAX_QTY', 'QTY_SIZE', 'MIN_NOTIONAL']
